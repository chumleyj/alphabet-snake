...
class GameView(arcade.View):
    ...
    def on_update(self, delta_time):
        ...
        if (len(snake_collision) > 0 or 
            self.snake.snake_head.center_x >= LETTER_SPACE['x_max'] or 
            self.snake.snake_head.center_x <= LETTER_SPACE['x_min'] or 
            self.snake.snake_head.center_y >= LETTER_SPACE['y_max'] or 
            self.snake.snake_head.center_y <= LETTER_SPACE['y_min']
            ):
            arcade.play_sound(self.yuck)
